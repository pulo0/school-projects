...
(NULL, 'John', 'Smith', '95040312345', 'Warszawa', 'Mazowiecka', 10, 5, '00-001', 'United Kingdom', '2012-03-15', 1),
(NULL, 'Emma', 'Johnson', '93121223456', 'Kraków', 'Krakowska', 15, 3, '30-001', 'United States', '2014-07-20', 11),
(NULL, 'Michael', 'Williams', '94052034567', 'Gdańsk', 'Gdańska', 20, 10, '80-001', 'Canada', '2013-11-10', 15),
(NULL, 'Sophia', 'Brown', '96072445678', 'Łódź', 'Piotrkowska', 30, 2, '90-001', 'Australia', '2015-05-05', 2),
(NULL, 'William', 'Taylor', '98101556789', 'Wrocław', 'Wrocławska', 40, 7, '50-001', 'Ireland', '2016-09-18', 15),
(NULL, 'Neil', 'Anderson', '99123067890', 'Poznań', 'Poznańska', 25, 1, '60-001', 'New Zealand', '2011-12-03', 2),
(NULL, 'James', 'Wilson', '97012378901', 'Szczecin', 'Szczecińska', 35, 4, '70-001', 'South Africa', '2017-02-28', 1),
(NULL, 'Ava', 'Miller', '00013189012', 'Bydgoszcz', 'Bydgoska', 5, 8, '80-001', 'United Arab Emirates', '2012-08-19', 15),
(NULL, 'Alexander', 'Davis', '02100790123', 'Katowice', 'Katowicka', 15, 6, '40-001', 'United States', '2013-04-17', 1),
(NULL, 'Mia', 'Jones', '04121901234', 'Gdynia', 'Gdyńska', 20, 9, '81-001', 'Canada', '2014-11-25', 15),
(NULL, 'Benjamin', 'Wilson', '05111212345', 'Warszawa', 'Marszałkowska', 12, 7, '00-100', 'United Kingdom', '2015-06-12', 13),
